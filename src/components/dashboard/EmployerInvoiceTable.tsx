...
import { Mail, ExternalLink, Filter, ChevronLeft, ChevronRight, Calendar, Coins, Globe, User, Clock, CheckCircle, XCircle, FileText, AlertCircle } from 'lucide-react';
import { Invoice } from '../../types';

interface EmployerInvoiceTableProps {
  invoices: Invoice[];
...
export default function EmployerInvoiceTable({ invoices, onViewInvoice }: EmployerInvoiceTableProps) {
  ...
  if (invoices.length === 0) {
    return (
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-8 md:p-12 text-center transition-colors duration-300">
        ...
        <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">No invoices to review</h3>
        <p className="text-gray-600 dark:text-gray-300">No invoices have been submitted for review yet</p>
      </div>
    );
  }
    ...
    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden transition-colors duration-300">
      ...
      <div className="px-4 md:px-6 py-4 border-b border-gray-200 dark:border-gray-700">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Invoice Reviews</h2>
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-gray-600 dark:text-gray-300 truncate text-xs">{invoice.freelancerEmail}</span>
                      </div>
                    </div>
